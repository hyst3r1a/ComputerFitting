...
namespace ComputerFitting
{
    ...
    {
        public Fitting fit;
        public List<Board> data = new List<Board>();
        public Motherboard()
        {
            InitializeComponent();
        }
        ...
        {
            string filename = "C:\\DB\\Board.data";
            using (var file = File.OpenRead(filename))
            {
                ...
                try
                {
                    data = (List<Board>)reader.Deserialize(file); // Reads the entire list.
                }
            ...
            for (int i = 0; i < data.Count; i++)
            {
                ...
                temp.SubItems.Add(data[i].maxMemory);
                temp.SubItems.Add(data[i].socket);
                temp.SubItems.Add(data[i].maxSocket);
                temp.SubItems.Add(data[i].maxPci);
            }

        }
        private void Motherboard_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveMotherboard();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox2.Text == "" || !int.TryParse(textBox2.Text, out temp))
            {
                ...
                if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                {
                    ...
                    a.maxPci = textBox7.Text;
                    a.socket = textBox8.Text;
                    a.maxMemory = textBox10.Text;
                    a.maxSocket = textBox9.Text;
            ...
            else
            {
                ...
                if (temp < data.Count)
                {
                    if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                    {
                        ...
                        data[temp].maxPci = textBox7.Text;
                        data[temp].socket = textBox8.Text;
                        data[temp].maxMemory = textBox10.Text;
                        data[temp].maxSocket = textBox9.Text;
        ...
        private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedIndices.Count != 0)
            {
                ...
                textBox8.Text = a.socket;
                textBox7.Text = a.maxPci;
                textBox9.Text = a.maxSocket;
                textBox10.Text = a.maxMemory;
