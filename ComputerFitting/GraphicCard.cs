...
namespace ComputerFitting
{
    ...
    public partial class GraphicCard : Form
    {
        public Fitting fit;
        public List<Graphics> data = new List<Graphics>();
        public GraphicCard()
        {
            InitializeComponent();
        }
        ...
        {
            string filename = "C:\\DB\\Graphics.data";
            using (var file = File.OpenRead(filename))
            {
                ...
                try
                {
                    data = (List<Graphics>)reader.Deserialize(file); // Reads the entire list.
                }
            ...
            for (int i = 0; i < data.Count; i++)
            {
                ...
                temp.SubItems.Add(data[i].shaderCores);
                temp.SubItems.Add(data[i].memorySize);
        ...
        private void GraphicCard_FormClosing(object sender, FormClosingEventArgs e)
        {
            SaveGraphicCard();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox2.Text == "" || !int.TryParse(textBox2.Text, out temp))
            {
                ...
                if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                {
                    ...
                    a.memorySize = textBox7.Text;
                    a.shaderCores = textBox8.Text;
            ...
            else
            {
                ...
                if (temp < data.Count)
                {
                    if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                    {
                        ...
                        data[temp].shaderCores = textBox8.Text;
                        data[temp].memorySize = textBox7.Text;
        ...
        private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedIndices.Count != 0)
            {
                textBox6.Clear();
                int temp = listView1.SelectedIndices[0];
                Graphics a = data[temp];
                textBox2.Text = temp.ToString();
                textBox3.Text = a.name;
                textBox5.Text = a.price;
                textBox4.Text = a.note;
                textBox8.Text = a.shaderCores;
                textBox7.Text = a.memorySize;
