...
namespace ComputerFitting
{
    ...
    {
        public Fitting fit;
        public List<Proc> data = new List<Proc>();
        public Processor()
        {
            InitializeComponent();
        }
        ...
        {
            string filename = "C:\\DB\\Processor.data";
            using (var file = File.OpenRead(filename))
            {
                ...
                try
                {
                    data = (List<Proc>)reader.Deserialize(file); // Reads the entire list.
                }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox2.Text == "" || !int.TryParse(textBox2.Text, out temp))
            {
                ...
                if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                {
                    ...
                    a.freq = textBox8.Text;
                    a.socket = textBox7.Text;
            ...
            else
            {
                ...
                if (temp < data.Count)
                {
                    if (textBox3.Text != "" && textBox4.Text != "" && textBox5.Text != "" && textBox6.Text != "")
                    {
                        ...
                        data[temp].freq = textBox8.Text;
                        data[temp].socket = textBox7.Text;
        ...
        private void ListView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listView1.SelectedIndices.Count != 0)
            {
                ...
                textBox8.Text = a.freq;
                textBox7.Text = a.socket;
